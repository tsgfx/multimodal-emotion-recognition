...
def main() -> None:
    ...
    device = get_device()
    train_ds = MultimodalEmotionDataset(args.metadata, "train", "face")
    val_ds = MultimodalEmotionDataset(args.metadata, "val", "face")
    ...
    for epoch in range(1, args.epochs + 1):
        train_loss, train_metrics = run_epoch(model, train_loader, criterion, optimizer, device, "face")
        val_loss, val_metrics = run_epoch(model, val_loader, criterion, None, device, "face")
        print(
